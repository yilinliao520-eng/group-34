...
\small
\renewcommand{\arraystretch}{1.08}
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}p{0.31\linewidth}r@{}}
\toprule
系统或参考 & 评估来源 & Success \\
\midrule
...
\bottomrule
\end{tabularx}
\caption{与已有 WebShop 结果的定位性比较。不同来源的评估协议不完全一致，因此该表用于说明结果量级，而非声明 benchmark SOTA。}
...
\balance
\section*{References}
\begin{list}{[\arabic{enumiv}]}{\usecounter{enumiv}\setlength{\leftmargin}{1.8em}\setlength{\labelsep}{0.45em}\setlength{\itemsep}{0.35em}\setlength{\parsep}{0pt}\setlength{\topsep}{0.2em}}

\item Shunyu Yao, Howard Chen, John Yang, and Karthik Narasimhan. 2022. WebShop: Towards Scalable Real-World Web Interaction with Grounded Language Agents. In \textit{Advances in Neural Information Processing Systems}.

\item Shunyu Yao, Jeffrey Zhao, Dian Yu, Nan Du, Izhak Shafran, Karthik Narasimhan, and Yuan Cao. 2023. ReAct: Synergizing Reasoning and Acting in Language Models. In \textit{International Conference on Learning Representations}.

\item Rafael Rafailov, Archit Sharma, Eric Mitchell, Stefano Ermon, Christopher D. Manning, and Chelsea Finn. 2023. Direct Preference Optimization: Your Language Model is Secretly a Reward Model. In \textit{Advances in Neural Information Processing Systems}.
