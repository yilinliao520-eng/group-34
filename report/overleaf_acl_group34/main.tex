...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.88\textwidth]{figures/workflow.pdf}
    \caption{实验流程。SFT 的主要问题是 repeated-search/no-buy loop，因此最终采用 SFT 与策略控制结合的结构。}
    \label{fig:workflow}
\end{figure*}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/main_results.pdf}
